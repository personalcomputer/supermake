...
def getLibs(header):
  ...
  for headerpart, library in libraries.items(): #I know, terrible :\. If this was C, I'd so be using gperf for all of this. Would be much more elegant, reliable, error-free, and faster. I have no problem programmaticly specifying hundreds of headers to gperf.
